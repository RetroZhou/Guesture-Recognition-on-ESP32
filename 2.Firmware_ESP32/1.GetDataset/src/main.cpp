...
void upload_dataset(float *p, uint8_t rows, uint8_t cols) {
  int i = 0;
  float val_limit;
  for (int y=0; y<rows; y++) 
  {
...
*/
  ...
  float dest_2d[THERMO_INPUT_SIZE];
  ...
  upload_dataset(dest_2d, INTERPOLATED_ROWS, INTERPOLATED_COLS);
